...
- $q = 48 // 18 = 2, r'' = 48 \pmod {18} = 12$, $(r, x, y, r', x', y')\\
	= (18, 0, 1, 12, 1 - 2 * 0, 0 - 2 * 1) = (18, 0, 1, 12, 1, -2)$
- $q = 18 // 12 = 1, r'' = 18 \pmod {12} = 6$, $(r, x, y, r', x', y')\\
	= (12, 1, -2, 6, 0 - 1 * 1, 1 - 1 * -2) = (12, 1, -2, 6, -1, 3)$
- $q = 12 // 6 = 2, r'' = 12 \pmod {6} = 0$, $(r, x, y, r', x', y')\\
...
<Bbox>
서로 서로수인 정수 $a$, 정수 $m$에 대하여, $a^{\phi(m)} \equiv 1 \pmod{m}$이다.
</Bbox>
